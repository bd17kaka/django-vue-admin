...
from .views import UserViewSet, OrganizationViewSet, PermissionViewSet, RoleViewSet, PositionViewSet, \
    TestView, DictTypeViewSet, DictViewSet, TaskViewSet, MeasurementViewSet, DatasetViewSet, \
    SolutionViewSet, TasktypeViewSet, Download, task_type_measurementViewSet, \
    task_dataset_measurementViewSet, solution_resultViewSet, dashboard_data
