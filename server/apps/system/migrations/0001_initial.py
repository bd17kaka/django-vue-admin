    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_name', models.CharField(max_length=50, unique=True, verbose_name='数据集名称')),
                ('description', models.CharField(max_length=2000, null=True, verbose_name='数据集详情')),
                ('addr', models.CharField(max_length=500, verbose_name='数据集地址')),
            ],
            options={
                'verbose_name': '数据集',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, help_text='修改时间', verbose_name='修改时间')),
                ('is_deleted', models.BooleanField(default=False, help_text='删除标记', verbose_name='删除标记')),
                ('solution_id', models.IntegerField(verbose_name='方案id')),
                ('dataset_id', models.IntegerField(verbose_name='数据集id')),
                ('measurement_id', models.IntegerField(verbose_name='评价指标id')),
                ('solution_result', models.CharField(max_length=500, null=True, verbose_name='运行结果')),
            ],
            options={
                'verbose_name': '方案-数据集-评价指标结果表',
                'verbose_name_plural': '方案-数据集-评价指标结果表',
            },
        ),
        migrations.CreateModel(
            name='task_dataset_measurement',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, help_text='创建时间', verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, help_text='修改时间', verbose_name='修改时间')),
            ...
            options={
                ...
                'verbose_name_plural': '任务-数据集-评价指标匹配表',
            },
        ),
        migrations.CreateModel(
            name='task_type_measument',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, help_text='创建时间', verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, help_text='修改时间', verbose_name='修改时间')),
                ('is_deleted', models.BooleanField(default=False, help_text='删除标记', verbose_name='删除标记')),
                ('task_type_id', models.IntegerField(verbose_name='任务类型id')),
                ('measurement_id', models.IntegerField(verbose_name='评价指标id')),
            ],
            options={
                'verbose_name': '任务类型-评价指标匹配',
                'verbose_name_plural': '任务类型-评价指标匹配',
            },
        ),
        migrations.CreateModel(
            name='Tasktype',
            fields=[
                ...
                ('tasktype_description', models.TextField(null=True, verbose_name='描述')),
            ],
            options={
                'verbose_name': '任务类型',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_dept', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='task_belong_dept', to='system.organization', verbose_name='所属部门')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_id', models.IntegerField(verbose_name='任务id')),
                ('solution_status', models.IntegerField(default=0, verbose_name='任务状态')),
                ('belong_dept', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='solution_belong_dept', to='system.organization', verbose_name='所属部门')),
                ('create_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='solution_create_by', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('update_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='solution_update_by', to=settings.AUTH_USER_MODEL, verbose_name='最后编辑人')),
            ],
            options={
                'verbose_name': '方案',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_dept', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='file_belong_dept', to='system.organization', verbose_name='所属部门')),
