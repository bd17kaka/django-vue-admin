# Generated by Django 3.0.7 on 2020-12-02 07:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_measurement', models.ManyToManyField(blank=True, to='system.Measurement', verbose_name='评价指标')),
            ],
            options={
                'verbose_name': '任务',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.BigIntegerField(null=True, verbose_name='所属用户id')),
                ('solutionResult', models.CharField(max_length=100, null=True, verbose_name='运行结果')),
